    ...
    for (int i = 0; i < 20; i++){
        for (int j = 0; j < 10; j++){
            switch (cuadricula.c[i][j]) {
                case 0: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, BLACK); break;
                case 1: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, SKYBLUE); break;
                case 2: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, GOLD); break;
                case 3: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, ORANGE); break;
                case 4: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, GREEN); break;
                case 5: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, PINK); break;
                case 6: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, BLUE); break;
                case 7: DrawRectangle(20 + 30 * j, 20 + 30 * i, 29, 29, PURPLE); break;
            }
        }
    }
}
